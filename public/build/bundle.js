    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1.textContent = "1.";
    			span1 = element("span");
    			span1.textContent = " 개요";
    			t7 = space();
    			div3 = element("div");
    			div2 = element("div");
    			div2.textContent = "21기 WP평균. 그중 커뮤니티 영역을 맡고있다. 前 테트리스 고인물 現 김승억 사무국장 놀리기 챔피언이다.";
    			...
    			add_location(div2, file$2, 10, 12, 620);
    			attr_dev(div3, "id", "section_2");
    			add_location(div3, file$2, 9, 8, 586);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path, "d", "M403.8 34.4c12-5 25.7-2.2 34.9 6.9l64 64c6 6 9.4 14.1 9.4 22.6s-3.4 16.6-9.4 22.6l-64 64c-9.2 9.2-22.9 11.9-34.9 6.9s-19.8-16.6-19.8-29.6V160H352c-10.1 0-19.6 4.7-25.6 12.8L284 229.3 244 176l31.2-41.6C293.3 110.2 321.8 96 352 96h32V64c0-12.9 7.8-24.6 19.8-29.6zM164 282.7L204 336l-31.2 41.6C154.7 401.8 126.2 416 96 416H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H96c10.1 0 19.6-4.7 25.6-12.8L164 282.7zm274.6 188c-9.2 9.2-22.9 11.9-34.9 6.9s-19.8-16.6-19.8-29.6V416H352c-30.2 0-58.7-14.2-76.8-38.4L121.6 172.8c-6-8.1-15.5-12.8-25.6-12.8H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H96c30.2 0 58.7 14.2 76.8 38.4L326.4 339.2c6 8.1 15.5 12.8 25.6 12.8h32V320c0-12.9 7.8-24.6 19.8-29.6s25.7-2.2 34.9 6.9l64 64c6 6 9.4 14.1 9.4 22.6s-3.4 16.6-9.4 22.6l-64 64z");
    			add_location(path, file, 13, 144, 557);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 512 512");
    			attr_dev(svg, "id", "random_icon");
    			attr_dev(svg, "data-v-3070b92f", "");
    			attr_dev(svg, "class", "svelte-1wt0w0g");
    			add_location(svg, file, 13, 46, 459);
    			attr_dev(a, "href", "/");
    			attr_dev(a, "title", "아무 문서로 이동");
    			attr_dev(a, "id", "random");
    			attr_dev(a, "class", "svelte-1wt0w0g");
    			add_location(a, file, 13, 4, 417);
    			...
    			input.value = "";
    			attr_dev(input, "class", "i8Hdr6+m svelte-1wt0w0g");
    			attr_dev(input, "data-v-3070b92f", "");
    			add_location(input, file, 14, 4, 1335);
    			attr_dev(form, "class", "search_bar svelte-1wt0w0g");
    			add_location(form, file, 12, 3, 387);
    			attr_dev(div0, "id", "search_tool");
    			attr_dev(div0, "class", "svelte-1wt0w0g");
    			add_location(div0, file, 11, 2, 361);
    			attr_dev(div1, "id", "tool_bar");
    			attr_dev(div1, "class", "svelte-1wt0w0g");
    			add_location(div1, file, 10, 1, 339);
    			attr_dev(div2, "id", "contents");
    			attr_dev(div2, "class", "svelte-1wt0w0g");
    			add_location(div2, file, 18, 1, 1504);
    			attr_dev(main, "class", "svelte-1wt0w0g");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div2, t3);
    			mount_component(aside, div2, null);
    			append_dev(div2, t4);
    			mount_component(section, div2, null);
    			append_dev(div2, t5);
