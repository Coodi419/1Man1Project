...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "디미위키";
    			attr_dev(h1, "class", "svelte-14v37dx");
    			add_location(h1, file$1, 1, 4, 14);
    			attr_dev(header, "class", "svelte-14v37dx");
    ...
    function create_default_slot(ctx) {
    	...
    	let article1;
    	let current;
    	article0 = new Article({ $$inline: true });
    	article1 = new Article({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(article0.$$.fragment);
    			t = space();
    			create_component(article1.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(article0, target, anchor);
    			insert_dev(target, t, anchor);
    			mount_component(article1, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(article0.$$.fragment, local);
    			transition_in(article1.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(article0.$$.fragment, local);
    			transition_out(article1.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(article0, detaching);
    			if (detaching) detach_dev(t);
    			destroy_component(article1, detaching);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-l4r43l");
    			add_location(main, file, 10, 0, 332);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
